...
/** 07 · Student profile setup. Students get the platform free under the campus plan. */
    ...
    <MobileShell
      footer={
        <div className="flex-none border-t border-tg-line px-[22px] pb-7 pt-3">
          <Button full size="lg" onClick={() => navigate(`${routes.institutionConsent}?role=student`)}>
            Enter Tangle
          </Button>
        </div>
      }
